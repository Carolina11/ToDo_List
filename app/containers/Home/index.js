...
export default class Home extends React.PureComponent {
  constructor() {
    super();
    this.state = {
      listItems:['Buy eggs','Paint deck','Wash car'],
      inputItem:"Have a great day"
    }
  };
  handleItem = (event) => {
    this.setState({
    ...
    return (
      <div className="container">
        ...
        <div className="inputContainer">
          <input type="text" className="todoInput" value={this.state.inputItem} onChange={this.handleItem} />
